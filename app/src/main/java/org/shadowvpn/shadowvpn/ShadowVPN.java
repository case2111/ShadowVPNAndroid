...
public class ShadowVPN {
    ...
    public ShadowVPN(final ParcelFileDescriptor pTUNFileDescriptor, final String pPassword,
            final String pUserToken, final String pServer, final int pPort) {
        this(pTUNFileDescriptor, pPassword, pUserToken, pServer, pPort,
                ShadowVPN.DEFAULT_MAXIMUM_TRANSMISSION_UNITS, ShadowVPN.DEFAULT_CONCURRENCY);
    }
    ...
    public void init() throws IOException {
        if (this.nativeInitVPN(this.mTUNFileDescriptor.getFd(), this.mPassword, this.mUserToken,
                this.mServer, this.mPort, this.mMaximumTransmissionUnits, this.mConcurrency) != 0) {
    ...
    protected native int nativeInitVPN(final int pTUNFileDescriptor, final String pPassword,
            final String pUserToken, final String pServer, final int pPort,
            final int pMaximumTransmissionUnits, final int pConcurrency);
